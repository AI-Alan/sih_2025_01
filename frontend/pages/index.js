                    ...
                    <div>
                        ...
                        <div className="card small">
                            ...
                            <ul style={{ marginTop: 8 }}>
                                <li><a href={process.env.NEXT_PUBLIC_GITHUB_URL} target="_blank" rel="noreferrer">Project Repo</a></li>
                                <li><a href={process.env.NEXT_PUBLIC_COLAB_URL} target="_blank" rel="noreferrer">Colab Notebook</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
